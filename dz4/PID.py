...
if __name__ == '__main__':
    ...
    #         signal_yaw_main = -82
    #
    #     #prelikavanje signala na postotke od -100% do 100%
    #     #sognali x i y vec jesu na rasponu od -100% do 100%
    #     #pogledaj sliku https://awwapp.com/s/a946c473-5c0f-43c5-b7ab-e153ac8c3a8c/
    #     signal_z_main =(2/125.0)*signal_z_main+0.6
    #
    #     signal_yaw_main =(1/82.0)*signal_yaw_main
    #
    ...
    #     # signal_yaw_main = signal_yaw_main*(1/164.0)+0.5
    #
    #
    #
    #
		# Mjerenja(signal_x=signal_x_main,signal_y=signal_y_main,signal_z=signal_z_main,signal_yaw=signal_yaw_main)
