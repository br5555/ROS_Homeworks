...
if __name__ == '__main__':
    ...
    PID_x = PID(K_pf_num=0.7148,K_pf_den=0.2852 ,Kr=7.0, Ti=35.0, Td=0.4, v=10.0, Integrator_max=1.0, Integrator_min=-1.0, T_dis = 0.084)
    PID_y = PID(K_pf_num=0.7148,K_pf_den=0.2852,Kr=7.0, Ti=35.0, Td=0.4, v=10.0, Integrator_max=1.0, Integrator_min=-1.0, T_dis = 0.084)
    PID_z = PID(K_pf_num=0.7198,K_pf_den=0.2802,Kr=10.0, Ti=30.0, Td=0.4, v=20.0, Integrator_max=25.0, Integrator_min=-100.0, T_dis = 0.2439)
    ...
    while True:
        ...
        if abs(PID_z.getSetPoint()-current_z)<0.03:
            i = i +  1
            if i > 50:
    ...
    while True:
        ...
        if abs(PID_x.getSetPoint()-current_x)<0.03:
            i = i +  1
            if i > 50:
                break
            else:
    ...
    while True:
        ...
        if abs(PID_y.getSetPoint()-current_y)<0.03:
            i = i +  1
            if i > 50:
                break
            else:
