...
if __name__ == '__main__':
    ...
    while True:
        ...
        current_y = Model_proces.ProcesY(signal_y_main)
        current_z = Model_proces.ProcesZ(signal_z_main)
        current_yaw = Model_proces.ProcesYaw(signal_yaw_main)
        ...
        if signal_yaw_main > 82:
            ...
            signal_yaw_main = -82
        bezvez = PID_x.getError()
        text_file.write("%s," % bezvez)
