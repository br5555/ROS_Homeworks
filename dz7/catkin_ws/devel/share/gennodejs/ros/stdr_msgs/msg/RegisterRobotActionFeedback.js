...
class RegisterRobotActionFeedback {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = RegisterRobotFeedback.serialize(obj.feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new RegisterRobotActionFeedback();
    ...
    tmp = RegisterRobotFeedback.deserialize(buffer);
